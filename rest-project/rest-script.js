...
function createNewPost() {
  ...
  const post = {
    title: 'New Post',
    body: 'This is the new post body read me.',
    userId: 1
  };
  fetch(`${baseUrl}/posts`, {
    method: 'POST',
...
const getAllPostsButton = document.getElementById('all-post');
getAllPostsButton.addEventListener('click', getAllPosts);

// Get post by ID button
const getPostByIdButton = document.getElementById('post-10');
getPostByIdButton.addEventListener('click', getPostById);

// Create new post button
const createNewPostButton = document.getElementById('create-post');
createNewPostButton.addEventListener('click', createNewPost);

// Replace post button
const replacePostButton = document.getElementById('replace-12');
replacePostButton.addEventListener('click', replacePost);

// Update post button
const updatePostButton = document.getElementById('update-12');
updatePostButton.addEventListener('click', updatePost);

// Delete post button
const deletePostButton = document.getElementById('delete-12');
